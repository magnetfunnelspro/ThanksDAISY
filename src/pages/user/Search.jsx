    ...
    <div className="w-full p-8 px-4 xl:px-16 flex flex-col gap-4 xl:gap-8 font-['Space_Grotesk'] text-stone-800">
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="w-full p-4 rounded-md border-2 border-r-4 border-b-4 border-stone-800 flex items-center gap-4">
            ...
            <input
              ...
              className="w-full leading-none outline-none placeholder:text-stone-600"
            />
          </div>
      ...
      {!searchTerm.trim() ? (
        ...
        <div className="p-20 px-0 flex flex-col items-center gap-4">
          <i className="ri-search-eye-line text-6xl text-stone-600"></i>
        ...
        <>
          ...
          {filteredProducts.length === 0 ? (
            <div className="p-20 px-0 flex flex-col items-center gap-4">
              <i className="ri-emotion-sad-line text-6xl text-stone-600"></i>
