  ...
  return (
    <div className="w-full p-8 px-4 flex flex-col items-center gap-4 font-['Space_Grotesk'] text-stone-800">
      ...
      <div className="p-4 rounded-full bg-stone-100">
        <i className="ri-check-line text-4xl text-stone-800"></i>
      </div>
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <div className="flex items-center gap-2 mt-1">
          <span className="text-sm text-stone-800">Order ID: {orderId}</span>

          <button
            onClick={handleCopy}
            className="text-stone-800 text-sm underline"
          >
            {copied ? "Copied!" : "Copy"}
          </button>
        </div>
      ...
      <div className="w-full xl:w-1/2 mt-4 flex flex-col gap-4">
        {steps.map((step, index) => (
          ...
          >
            <div className="p-2.5 px-4 rounded-full text-sm font-semibold text-white bg-stone-800">
              {index + 1}
            </div>
      ...
      <div className="flex flex-col md:flex-row gap-3 mt-6 w-full max-w-md">
        ...
        <button
          ...
          className="w-full p-4 rounded-md font-semibold border-2 border-r-4 border-b-4 border-stone-800 text-stone-800"
        >
          Contact us
        </button>
      </div>
