    ...
    <div className="w-full p-8 px-4 xl:px-16 flex flex-col xl:flex-row gap-12 xl:gap-24 font-['Space_Grotesk'] text-stone-800">
      ...
      <div className="w-full xl:w-[40%] flex flex-col gap-4 xl:gap-8">
        ...
        <div className="grid grid-cols-3 xl:grid-cols-1 gap-4 xl:gap-8">
          ...
          >
            <i className="ri-whatsapp-line text-2xl text-stone-800"></i>
            <h4 className="font-semibold text-stone-800">WhatsApp</h4>
          ...
          <button
            ...
            className="p-4 rounded-md flex flex-col items-center gap-2 bg-stone-100"
          >
            <i className="ri-mail-line text-2xl text-stone-800"></i>
        ...
        {!success ? (
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <input
              ...
              required
              className="p-4 text-sm font-semibold rounded-md border-2 border-b-4 border-stone-800 outline-none placeholder:text-stone-600 text-stone-800"
            />
            ...
            <textarea
              ...
              onChange={handleChange}
              required
              className="p-4 text-sm font-semibold rounded-md border-2 border-b-4 border-stone-800 outline-none placeholder:text-stone-600 text-stone-800 resize-none"
            ></textarea>

            <button
              type="submit"
              className="p-4 font-semibold rounded-md border-2 border-b-4 border-stone-800 text-white bg-stone-800"
            >
              Send Message
            </button>
          </form>
        ) : (
          <div className="p-4 text-center font-semibold rounded-md text-stone-800 bg-stone-100">
